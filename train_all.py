...
def main():
    ...
    parser.add_argument("--model_save", default=1, type=int, help="Model save start step")
    ...
    # XXX change checkpoint path
    args.checkpoint_root = "/home/yuwenlong/data" / Path("train_output") / args.dataset
    args.checkpoint_path = args.checkpoint_root / args.unique_name
    args.checkpoint_path.mkdir(exist_ok=True, parents=True)
